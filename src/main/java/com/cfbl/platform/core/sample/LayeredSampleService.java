...
/**
 * Layered sample service that returns integration-layer {@link ProviderResult} values.
 */
@Service
public class LayeredSampleService {
    ...
    public Mono<ProviderResult<String>> createSample(String customerId) {
        ...
        return restCallExecutor.executeProvider(
                ...
                "createSample",
                SAMPLE_PATH,
                client -> client.post().uri(SAMPLE_PATH).bodyValue(new CreateSampleRequest(customerId)),
                String.class,
